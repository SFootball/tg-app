build:
	docker build --platform=linux/amd64 --tag space-football.cr.cloud.ru/sfootball_tgapp:v.1.5.2 .
local_build:
	docker build  -t sfootball_tgapp_local .
push:
	docker push space-football.cr.cloud.ru/sfootball_tgapp:v.1.5.2
# tag:
